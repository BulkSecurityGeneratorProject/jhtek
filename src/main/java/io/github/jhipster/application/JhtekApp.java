...
public class JhtekApp {

    private static final Logger log = LoggerFactory.getLogger(JhtekApp.class);

    private final Environment env;

    public JhtekApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhtekApp.class);
